...
public class ItemMasterDetailController {
		...
		@RequestMapping(value = "/itemmasterdetail", method = RequestMethod.GET)
		public String itemmasterdetail(@RequestParam("itemId") String itemId,Model model){
